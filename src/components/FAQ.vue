<template>
  <div>
    ...
    <div v-if="showFAQ">
      ...
      <p>if you know how to use github, go ahead and submit a PR with an mp3 in the app assets. or, just hit me up on <a href="https://bsky.app/profile/mattpolicastro.bsky.social" target="_blank" rel="noopener">bluesky</a>.</p>
      <h3>privacy?</h3>
      <p>seriously, there is nothing in this app that is designed to send your posts elsewhere. the post history is stored on your device using <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage" target="_blank" rel="noopener">localStorage</a>. if the post history is a deal-killer, just let me know on bluesky or github.</p>
